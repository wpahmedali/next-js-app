...
export function UkFlagIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <defs>
        <clipPath id="uk-flag_svg__clip-path">
          <path
            d="M0 0h32v21H0z"
            style={{
              fill: "none",
        ...
        <style>
          {
            ".uk-flag_svg__cls-2{clip-path:url(#uk-flag_svg__clip-path)}.uk-flag_svg__cls-4{fill:#ce1124}.uk-flag_svg__cls-5{fill:#00247d}"
          }
        </style>
      </defs>
      <path
        d="M31.99 20.97H0V0h31.99v20.97z"
        className="uk-flag_svg__cls-2"
        style={{
          fill: "#fff",
        }}
      />
      <path
        ...
        className="uk-flag_svg__cls-4"
      />
      <g className="uk-flag_svg__cls-2">
        <path
          d="M0 2.44v4.57h6.98L0 2.44zM3.85 0h-.1l9.04 5.96V0H3.85z"
          className="uk-flag_svg__cls-5"
        />
        <path
