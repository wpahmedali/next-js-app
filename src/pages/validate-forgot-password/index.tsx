...
import ValidateOtpForgotPassword from 'components/forgot-password/components/VerificationOtpForm';
...
validateforgotpassword.getLayout = function getLayout(page) {
