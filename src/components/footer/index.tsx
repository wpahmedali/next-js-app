  ...
  return (
    <footer className="bg-primaryDark text-white">
      <div className="mx-auto w-full p-4 py-6 lg:py-8 xl:px-52 2xl:px-52 lg:px-24 md:px-4 sm:px-2 xs:px-2 xxs:px-2">
        <div className="grid gap-8 sm:gap-6 2xl:grid-cols-5 xl:grid-cols-5 lg:grid-cols-5 md:grid-cols-5 sm:grid-cols-2 xs:grid-cols-2 xxs:grid-cols-2 sm:mb-2 xs:mb-2 xxs:mb-2">
