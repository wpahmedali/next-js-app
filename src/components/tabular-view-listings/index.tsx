...
import TabularHeader from 'components/tabular-view-listings/components/TabularHeader';
import VehicleItem from 'components/tabular-view-listings/components/vehicle-item';
