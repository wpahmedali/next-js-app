    ...
    <div>
      <div className="mb-4">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          ...
          It is issued by the customs presenting the total assigned value and
          the corresponding duty charged on the cargo. Please also see "Export
          Permit".
        </p>
      </div>
      <div className="mb-4">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          ...
          agent to the shipper or their agent, and it works as Receipt of Goods,
          Evidence of Contract of Carriage between the freight carrier and the
          shipper, and Document of Title to the goods. A completed B/L legally
          shows that the carrier has received the freight as described and is
          obligated to deliver that freight in good condition to the consignee.
          The information in the B/L is critical as it directs the actions of
          personnel all along the route of the shipment - where it is going, the
          piece count, how it is billed, and how it is to be handled on the dock
          and trailers. The original B/L must be presented in order to release
          the cargo at the destination to the consignee on delivery.
        </p>
      </div>
      <div className="mb-4">
        <h3 className="flex items-center mb-4 text-base font-medium dark:text-white shadow-lg bg-black hover:bg-[#fccf3a] text-white py-2 px-3">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          ...
          all the means of transportation of the goods necessary to bring the
          goods to a named port of destination.
        </p>
      </div>
      <div className="mb-4">
        <h3 className="flex items-center mb-4 text-base font-medium dark:text-white shadow-lg bg-black hover:bg-[#fccf3a] text-white py-2 px-3">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          ...
          Please also see "Export Certificate".
        </p>
      </div>
      <div className="mb-4">
        <h3 className="flex items-center mb-4 text-base font-medium dark:text-white shadow-lg bg-black hover:bg-[#fccf3a] text-white py-2 px-3">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          ...
          which usually takes within a week. Please visit our VAP page for more
          information about VAP features.
        </p>
      </div>
      <div className="mb-4">
        <h3 className="flex items-center mb-4 text-base font-medium dark:text-white shadow-lg bg-black hover:bg-[#fccf3a] text-white py-2 px-3">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          ...
          means of transportation of the goods necessary to bring the goods to a
          named port of destination. In this term, the seller pays for the
          freight and marine insurance only up to the port of destination;
          therefore, the freight and insurance there after from the arrival port
          up to the final destination of the buyer has to be paid by the buyer
          only.
        </p>
      </div>
      <div className="mb-4">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          ...
          such as arranges to pass the relevant documents at customs, arrange
          for customs inspections as required, and process Duty and VAT payments
          as applicable.
        </p>
      </div>
      <div className="mb-4">
      ...
      <div className="mb-4">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          ...
          does not have the Export Certificate, the vehicle cannot be exported
          from Japan. (i.e. The car that had previously been registered in Japan
          has been cancelled.)
        </p>
      </div>
      <div className="mb-4">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          ...
          goods as well as the quantity, price, and any other necessary
          particulars. An export permit must also be obtained after the
      ...
      <div className="mb-4">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          ...
          JAPAN website, refers to the vehicle price only. Any freight charges
          will be added to the FOB price when you purchase the vehicle from us.
          After receiving the vehicle, you will be responsible for paying any
          port clearing costs, import duties, taxes and any others fees required
          by your country and/or the port of discharge.
        </p>
      </div>
    </div>
  );
};
export default LeftGlossary;
