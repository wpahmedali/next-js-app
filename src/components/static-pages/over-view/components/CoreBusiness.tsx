    ...
    <div className="container mx-auto">
      <h1 className="text-white">Jan Japan is your premier destination for superior used Japanese cars, tires and electronics. Since our inception in 1999, we have proudly operated from the bustling city of Kobe, Japan, serving as a cornerstone in the export industry of top-quality Japanese goods.</h1>
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-3 lg:gap-6 lg:pt-8">
          <div className="p-4">
            <Image className="h-auto max-w-full" src="/asset/images/profile/core-business.png" alt=".." />
          </div>
          ...
          <div className="p-4">
            <Image className="h-auto max-w-full" src="/asset/images/profile/global-network.png" alt=".." />
          </div>
          <div className="p-4">
            <Image className="h-auto max-w-full" src="/asset/images/profile/domestic-network.png" alt=".." />
          </div>
          <div className="lg:col-span-2 my-auto items-center">
          ...
          <div className="p-4">
            <Image className="h-auto max-w-full" src="/asset/images/profile/procurement.png" alt=".." />
          </div>
          <div className="p-4">
            <Image className="h-auto max-w-full" src="/asset/images/profile/our-mission.png" alt=".." />
          </div>
          <div className="lg:col-span-2 my-auto items-center">
          ...
          <div className="p-4">
            <Image className="h-auto max-w-full" src="/asset/images/profile/cultivating.png" alt=".." />
          </div>
