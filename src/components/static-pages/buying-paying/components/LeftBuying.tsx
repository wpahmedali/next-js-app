    ...
    <div>
      <div className="mb-4">
        ...
        <ol className="list-decimal px-6 text-sm">
          <li>
            Visit our website and click on the vehicle you like in order to
            access our Total Price Calculator.
          </li>
          <li>
            Fill in all required information in the calculator and the personal
            information in the Free Quote section, then click on “FREE QUOTE” to
            send us an inquiry.
          </li>
          <li>
            Once our staff responds to your inquiry, the negotiation process
            will start.
          </li>
          <li>
            You will be notified once we (you and Jan Trading) reach an
            agreement on the pricing and conditions.
          </li>
          <li>You will receive the Proforma Invoice.</li>
        </ol>
      </div>
      <div className="mb-4">
        <h3 className="flex items-center mb-4 text-base font-medium dark:text-white shadow-lg bg-black hover:bg-[#fccf3a] hover:text-black cursor-pointer text-white py-2 px-3">
        ...
        <p className="text-black text-sm">
          ...
          found in our FAQ section “Country Regulations”.
        </p>
      </div>
      <div className="mb-4">
        <h3 className="flex items-center mb-4 text-base font-medium dark:text-white shadow-lg bg-black hover:bg-[#fccf3a] hover:text-black cursor-pointer text-white py-2 px-3">
      ...
      <div className="mb-4">
        ...
        <p className="text-black text-sm">
          ...
          required for the interbank transactions.
        </p>
      </div>
      <div className="mb-4">
        <h3 className="flex items-center mb-4 text-base font-medium dark:text-white shadow-lg bg-black hover:bg-[#fccf3a] hover:text-black cursor-pointer text-white py-2 px-3">
