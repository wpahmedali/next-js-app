...
import { useSpecialVehicleList } from 'react-query/hooks/api/special-vehicle-list';

const SpecialTabularListing = () => {
...
export default SpecialTabularListing;
